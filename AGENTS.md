...
- **QUOTAS:** Default to `ollama/kimi-k2.5:cloud` for routine/background work. Use `google-gemini-cli/gemini-3-flash-preview` for image tasks and as fallback. Reserve `openai-codex/gpt-5.3-codex` for premium reasoning only.
