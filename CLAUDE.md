...
- Use `trash` not `rm`.
- Default model: `ollama/kimi-k2.5:cloud` → fallback `google-gemini-cli/gemini-3-flash-preview` → `ollama/qwen2.5-coder:7b`. Reserve `openai-codex/gpt-5.3-codex` for high-risk bugs only.
